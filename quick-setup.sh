...
# other apps
sudo pacman -S --noconfirm man-db man-pages zip unzip bc calc baobab neofetch mpv mesa-demos nm-connection-editor networkmanager-pptp # utilities android-file-transfer
